...
Để đánh giá độ ổn định của mô hình cuối cùng, nhóm sử dụng phương pháp Bootstrap với 1000 lần lấy mẫu có hoàn lại từ tập huấn luyện. Sai số chuẩn bootstrap được sử dụng để đánh giá mức độ biến động của các hệ số hồi quy dưới những mẫu dữ liệu khác nhau (14)
