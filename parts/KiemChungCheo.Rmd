...
- Chia ngẫu nhiên dữ liệu gốc thành hai phần độc lập: **Tập huấn luyện** (Training Set) chiếm phần lớn dùng để xây dựng mô hình và **Tập kiểm chứng** (Validation set / Hold-out set) là phần còn lại không cho mô hình biết trước, dùng để tính lỗi sau khi mô hình đã học xong [@James2023].
