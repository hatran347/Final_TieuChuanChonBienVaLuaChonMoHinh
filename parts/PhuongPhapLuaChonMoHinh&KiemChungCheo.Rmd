...
$$\text{Total}_{\text{Backward}} = 1 + p + (p-1) + (p-2) + \dots + 2 = 1 + \frac{(p+2)(p-1)}{2}$$ (Công thức này xấp xỉ bằng $\frac{p(p+1)}{2}$ tương tự như Forward Selection).
...
- **Tổng số mô hình tối đa mà Stepwise phải tính toán xấp xỉ:** $$\text{Total}_{\text{Stepwise}} \approx p^2$$
